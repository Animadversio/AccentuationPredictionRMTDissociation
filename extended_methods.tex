...
% Content: teacher w* = disk; student f_1 = w*; student f_2 = w* + weight
% along low-variance PCs; held-out van Hateren evaluation; seed image;
% target levels r*; variance-matched step alpha; peer-review panels
% (f_i evaluated on accentuations of f_j).
% SOURCE CODE NOT YET LOCATED (not in AccentuationPredRMT).
\todo{Write once the generating code/parameters are located.}
