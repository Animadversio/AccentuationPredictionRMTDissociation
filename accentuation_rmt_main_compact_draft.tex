...
\usepackage{url}
\usepackage{hyperref}
% Link text in a deep sakura pink instead of the default red boxes.
\definecolor{sakurapink}{RGB}{214,86,128}
\hypersetup{colorlinks=true,linkcolor=sakurapink,citecolor=sakurapink,urlcolor=sakurapink}
...
\usepackage{xspace}
\newcommand{\citetPW}{Prince, Wang, et~al.\ \citeyearpar{prince2026parametric}\xspace}
