...
\tilde\beta_\kappa:=F^\top(\Sigma_F+\kappa I_p)^{-1}F\Sigma\bstar
...
lies in the range of $\Sigma_F$.  The third form of $\tilde\beta_\kappa$ is the
...
\]
The first piece is $\|F^\top(\Sigma_F+\kappa I)^{-1}\Sigma_Fw^\star\|^2=\|\tilde\beta_\kappa\|^2$,
...
$\tilde w_\kappa:=\Sigma_F(\Sigma_F+\kappa I)^{-1}w^\star=w^\star-\kappa(\Sigma_F+\kappa I)^{-1}w^\star$
...
=(F\bstar-\Gram\tilde w_\kappa)^\top\tilde w_\kappa\\
&=\big(\Gram w^P-\Gram w^\star+\kappa \Gram(\Sigma_F+\kappa I)^{-1}w^\star\big)^\top\tilde w_\kappa
=(w^P-w^\star)^\top \Gram\tilde w_\kappa+\kappa\,{w^\star}^\top(\Sigma_F+\kappa I)^{-1}\Gram\tilde w_\kappa .
\end{align*}
...
$\|\tilde\beta_\kappa\|^2=h^\top(\Sigma_F+\kappa I)^{-1}\Gram(\Sigma_F+\kappa I)^{-1}h$ and
...
$G_{1\leftarrow2}\asymp\tilde\beta_1^\top\tilde\beta_2/{\bstar}^\top\tilde\beta_2$
with $\tilde\beta_i=F_i^\top(\Sigma_{F_i}+\kappa_iI)^{-1}F_i\Sigma\bstar$, which
...
$g_i\asymp\tilde\beta_i$ in quadratic forms
...
recordings are used for every model.  Replacing $g_i$ by $\tilde\beta_i$ and
...
\[
B_{p,q}\ge B_{p+1,q+1},\qquad \mathrm{df}_{p,q}\ge\mathrm{df}_{p+1,q+1},
\]
