...
Eq.~\ref{eq:feat_regr_optim_weight}, and $Cw^\star=F\Sigma\bstar$ is
...
with $\tilde\beta_i=F_i^\top(C_i+\kappa_iI)^{-1}F_i\Sigma\bstar$, which
...
$\operatorname{Tr}[G_Q(\Sigma_\phi+\kappa I)^{-2}\Sigma_\phi]=\sum_kq_k\,s_k/(s_k+\kappa)^2$
with $G_Q:=\E_Q[J_\phi J_\phi^\top]$ and $q_k:=\E_Q\|\nabla_x(v_k^\top\phi)\|^2$
