...
Here we consider a classical set up where a linear model is learning from a linear teacher with additive noise. 
This system is very well studied, with ample beautiful papers. 
...
\subsection{Linear Feature Regression: Effect of feature projection and gradient}
