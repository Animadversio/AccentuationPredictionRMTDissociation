...
\begin{figure}[t]
    ...
    \begin{tikzpicture}[x=1cm,y=1cm,>=Latex,font=\scriptsize]
        ...
        \begin{scope}[xshift=-2.2cm]
            ...
            \draw[->,black,very thick] (0,0)--(1.45,0.15)
                node[above right] {$\bstar$};
            \draw[->,blue!70!black,very thick] (0,0)--(1.5,0)
                node[below right] {$\bhat_1$};
...
For isotropic data, these two geometries are proportional and this particular hiding mechanism is absent.
