...
\begin{figure}
    ...
    \caption{Neuronal Control Results}
...
\begin{figure}
    ...
    \caption{A linear model recapitulating the phenomena}
...
Our main analytical tool is a collection of deterministic equivalents (DEs) relationships applied to the quadratic forms $N$ and $D$. These relations replace resolvents of the random sample covariance $\hat\Sigma$ with those of the population covariance $\Sigma$. Finite-sample randomness is summarized at leading order by an effective regularization parameter $\kappa$, determined by the self-consistent Silverstein equation \todo{add meaning of equivalence??}
\begin{equation}
...
Notably, there are two sense of optimality, for prediction vs for reconstruction,
