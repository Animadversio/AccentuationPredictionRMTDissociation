...
\begin{figure}[t]
    ...
    This picture is validated by the numerical MC estimated landscapes in Fig.~\ref{}. 
    \textbf{D,E}~Slices at four noise levels expose displaced prediction and control valleys (peaks for $R^2$); markers and bands show the mean and 10--90\% range over 100 natural-image trials at the highlighted noise $\sigma^2/S=1$.
