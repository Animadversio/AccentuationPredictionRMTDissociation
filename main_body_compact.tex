...
These phenomena are puzzling at first glance, though we show, even linear models on natural images can reproduce all three observations (\red{
...
%     \centering
%     \includegraphics[width=\linewidth]{figures/Figure_LinearToyModel-04.png}
%     % \includegraphics[width=\linewidth]{figures/Figure_LinearToyModel-02.png}
%     \caption{Caption}
